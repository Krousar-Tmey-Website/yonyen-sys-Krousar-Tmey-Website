...
<section class="py-20 lg:py-28 bg-[#f8f9fc]" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 {{ $gridCols }} gap-8 justify-center">
            ...
            <div class="card group relative overflow-hidden rounded-[2rem] shadow-xl h-[420px] cursor-pointer text-center text-white" data-reveal="up" style="--reveal-delay: {{ $loop->index * 120 }}" x-data="{ adminMenuOpen: false }">
                {{-- Background Image --}}
                ...
                <div class="absolute top-4 right-4 z-50 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity duration-300">
                    ...
                    <div x-show="adminMenuOpen" x-cloak @click.away="adminMenuOpen = false"
                        ...
                        <a href="{{ route('programs') }}#{{ $program->slug }}" class="flex items-center gap-2.5 px-4 py-2.5 hover:bg-gray-50 transition-colors">
                            <svg class="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                            {{ __('View More Detail') }}
                        </a>
                        <a href="{{ route('admin.programs.edit', $program) }}" class="flex items-center gap-2.5 px-4 py-2.5 hover:bg-gray-50 transition-colors border-t border-gray-100">
...
<section class="py-16 lg:py-24 bg-white border-t border-gray-100" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="bg-[#f8f9fc] rounded-2xl p-7 border border-gray-100 card-hover-light group relative flex flex-col h-full" data-reveal="up" style="--reveal-delay: {{ $loop->index * 100 }}" x-data="{ adminMenuOpen: false }">
                {{-- Main Card Link --}}
...
<section class="py-20 lg:py-28 bg-white" data-reveal>
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article class="card group relative overflow-hidden rounded-[2rem] shadow-xl h-[420px] cursor-pointer text-center text-white" data-reveal="up" style="--reveal-delay: {{ $loop->index * 100 }}" x-data="{ adminMenuOpen: false }">
                {{-- Background Image --}}
