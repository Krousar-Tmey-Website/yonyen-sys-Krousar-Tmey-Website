                ...
                <div class="bg-[#f8f9fc] rounded-2xl p-7 border border-gray-100 hover:shadow-md transition-shadow group flex flex-col gap-5">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @if ($report->has_pdf_file)
                            <a href="{{ $report->file_url }}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center rounded-lg border border-[#1a3c6e] px-3 py-2 text-sm font-semibold text-[#1a3c6e] hover:bg-[#1a3c6e] hover:text-white transition-colors">
                                View PDF
                            </a>
                            <a href="{{ $report->file_url }}" download="{{ $report->original_filename ?? $report->title . '.pdf' }}" class="inline-flex items-center justify-center rounded-lg bg-[#e8a020] px-3 py-2 text-sm font-semibold text-white hover:bg-[#c7830d] transition-colors">
                                Download PDF
                            </a>
                        @else
