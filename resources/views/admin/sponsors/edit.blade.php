...
<div class="max-w-3xl mx-auto" x-data="{ logoMethod: '{{ str_starts_with($sponsor->logo ?? '', 'http') ? 'url' : 'file' }}', fileName: '', lang: 'en' }">
