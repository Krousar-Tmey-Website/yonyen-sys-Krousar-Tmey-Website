...
<div x-data="{ tab: '{{ request('tab', 'banner') }}' }">
    ...
    <div x-show="tab === 'banner'" class="space-y-6">
        ...
        {{-- Banner Form --}}
        <form action="{{ route('admin.news-banner.update') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5" x-data="bilingualForm()">
            @csrf
            ...
            <div>
                ...
                <div x-show="lang === 'fr'" x-cloak>
                    <input type="text" id="news_banner_badge_fr" name="news_banner_badge_fr"
                           value="{{ $bv('news_banner_badge_fr') }}"
            ...
            <div>
                ...
                <div x-show="lang === 'en'">
                    <x-admin.rich-text name="news_banner_subtitle" :value="$bannerSubtitle" lang="en" :rows="2"
                                       placeholder="Updates from our programs, success stories from our beneficiaries..." />
                </div>
                <div x-show="lang === 'fr'" x-cloak>
                    <x-admin.rich-text name="news_banner_subtitle_fr" :value="$bannerSubtitleFr" lang="fr" :rows="2"
                                       placeholder="Actualités de nos programmes, réussites de nos bénéficiaires…" />
            ...
            <div class="border-t border-gray-100 pt-4 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div x-show="lang === 'fr'" x-cloak>
                            <input type="text" id="news_banner_btn1_text_fr" name="news_banner_btn1_text_fr"
                                   value="{{ $bv('news_banner_btn1_text_fr') }}"
                                   placeholder="Leave blank to reuse the English text"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div x-show="lang === 'fr'" x-cloak>
                            <input type="text" id="news_banner_btn2_text_fr" name="news_banner_btn2_text_fr"
                                   value="{{ $bv('news_banner_btn2_text_fr') }}"
                                   placeholder="Leave blank to reuse the English text"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div x-show="lang === 'fr'" x-cloak>
                            <input type="text" id="news_banner_btn3_text_fr" name="news_banner_btn3_text_fr"
                                   value="{{ $bv('news_banner_btn3_text_fr') }}"
                                   placeholder="Leave blank to reuse the English text"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                        </div>
                    </div>
