...
<div class="table-container">
    ...
    <div class="empty-state">
        ...
        <a href="{{ route('admin.news.create') }}" class="inline-flex items-center gap-2 mt-4 text-[#2d6fa3] font-medium  transition-colors text-sm">
                ...
                <tr data-category="{{ $article->category }}" data-status="{{ $article->is_published ? 'published' : 'draft' }}">
                    <td>
                        <div class="flex items-center gap-3">
                            ...
                            @endif
                            <div class="min-w-0">
                                <div class="font-medium text-gray-800 transition-colors truncate max-w-xs">
                                    {{ $article->title }}
                                </div>
                                @if($article->excerpt)
