...
<div class="form-group" x-show="lang === 'en'">
                ...
                <div class="form-group form-group--no-margin" x-show="lang === 'en'">
                    ...
                    <x-admin.rich-text name="excerpt" :value="old('excerpt')" lang="en" :rows="2" placeholder="Short summary for article cards..." />
                ...
                <div class="form-group form-group--no-margin" x-show="lang === 'fr'" x-cloak>
                    ...
                    <x-admin.rich-text name="excerpt_fr" :value="old('excerpt_fr')" lang="fr" :rows="2" placeholder="Résumé court pour les cartes d'article..." />
