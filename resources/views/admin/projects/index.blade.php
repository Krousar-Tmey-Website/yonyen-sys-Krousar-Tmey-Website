...
<div class="flex items-center justify-between mb-6">
    <h2 class="text-gray-700 font-semibold">All Projects</h2>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
        ...
        <div class="p-5">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <form action="{{ route('admin.projects.destroy', $item) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Project?');" class="inline-block">
                    @csrf
                    @method('DELETE')
