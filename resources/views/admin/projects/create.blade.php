...
<div x-show="lang === 'en'">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" x-data="bilingualForm()">
            ...
            <div x-show="lang === 'en'">
                ...
                <x-admin.rich-text name="activities" :value="old('activities')" lang="en" :rows="3" placeholder="Activity 1..." />
            ...
            <div x-show="lang === 'fr'" x-cloak>
                ...
                <x-admin.rich-text name="activities_fr" :value="old('activities_fr')" lang="fr" :rows="3" placeholder="Activité 1..." />
                <p class="mt-1 text-xs text-gray-400">Shown to French-language visitors. Leave blank to reuse the English value.</p>
            </div>
        </div>
