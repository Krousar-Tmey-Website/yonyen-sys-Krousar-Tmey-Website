...
<div x-show="lang === 'en'">
                ...
                <div x-show="lang === 'en'">
                    ...
                    <x-admin.rich-text name="description" :value="old('description', $item->description)" lang="en" :rows="2" />
                ...
                <div x-show="lang === 'fr'" x-cloak>
                    ...
                    <x-admin.rich-text name="description_fr" :value="old('description_fr', $item->description_fr)" lang="fr" :rows="2" />
                    <p class="mt-1 text-xs text-gray-400">Shown to French-language visitors. Leave blank to reuse the English value.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" x-data="bilingualForm()">
            ...
            <div x-show="lang === 'en'">
                ...
                <x-admin.rich-text name="objective" :value="old('objective', $item->objective)" lang="en" :rows="2" />
            </div>
            <div x-show="lang === 'fr'" x-cloak>
                ...
                <x-admin.rich-text name="objective_fr" :value="old('objective_fr', $item->objective_fr)" lang="fr" :rows="2" />
                <p class="mt-1 text-xs text-gray-400">Shown to French-language visitors. Leave blank to reuse the English value.</p>
            </div>

            <div x-show="lang === 'en'">
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Project Content (HTML Supported)</label>
                <x-admin.rich-text name="content" :value="old('content', $item->content)" lang="en" :rows="5" placeholder="Full content..." />
            </div>
            <div x-show="lang === 'fr'" x-cloak>
                ...
                <x-admin.rich-text name="content_fr" :value="old('content_fr', $item->content_fr)" lang="fr" :rows="5" placeholder="Contenu complet..." />
                <p class="mt-1 text-xs text-gray-400">Shown to French-language visitors. Leave blank to reuse the English value.</p>
            </div>
        ...
        <div class="bg-[#2d6fa3]/5 rounded-2xl border border-[#2d6fa3]/10 p-6 space-y-4" x-data="bilingualForm()">
            ...
            <div x-show="lang === 'en'">
                ...
                <x-admin.rich-text name="testimony_story" :value="old('testimony_story', $item->testimony_story)" lang="en" :rows="4" />
            </div>
            <div x-show="lang === 'fr'" x-cloak>
                ...
                <x-admin.rich-text name="testimony_story_fr" :value="old('testimony_story_fr', $item->testimony_story_fr)" lang="fr" :rows="4" />
                <p class="mt-1 text-xs text-gray-400">Shown to French-language visitors. Leave blank to reuse the English value.</p>
            </div>
        </div>
