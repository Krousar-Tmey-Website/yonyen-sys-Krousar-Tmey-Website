            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-4" x-data="bilingualForm()">
                ...
                <div x-show="lang === 'en'" class="space-y-4">
                    ...
                    <div>
                        ...
                        <x-admin.rich-text name="subtitle" :value="old('subtitle')" lang="en" placeholder="Supporting disadvantaged children through education, culture, and welfare programs..." />
                    </div>
                </div>
