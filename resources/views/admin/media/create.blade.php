...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="font-bold text-gray-800">New Media Item</h3>
                <p class="text-sm text-gray-400 mt-0.5">Add a new media item to the public Media page.</p>
            </div>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 bg-gray-50/30 text-center cursor-pointer hover:border-[#2d6fa3]/40 transition-colors"
                        ...
                        <div id="imagePlaceholder">
                            ...
                            <p class="text-sm font-medium text-gray-600 mb-1">Click to upload</p>
