                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="inline-flex items-center gap-2 justify-end">
                                ...
                                <form action="{{ route('admin.volunteers.destroy', $volunteer) }}" method="POST" class="inline delete-model-form">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" title="Delete" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-50 text-red-600 hover:bg-red-100 transition-all delete-volunteer-button">
...
<!-- Delete Modal (dynamically created if needed) -->
@push('scripts')
<script>
