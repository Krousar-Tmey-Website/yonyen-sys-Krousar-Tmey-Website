...
<div x-data="{ tab: 'reports' }">
    ...
    $bannerTitleFr = $bv('resources_banner_title_fr');
    ...
    <div x-show="tab === 'banner'" class="space-y-6">
        ...
        <form action="{{ route('admin.resources-banner.update') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5" x-data="bilingualForm()">
            ...
            <div>
                ...
                <div x-show="lang === 'fr'" x-cloak>
                    <x-admin.rich-text name="resources_banner_title_fr" :value="$bannerTitleFr" lang="fr" :rows="1" placeholder="Ressources et rapports annuels" />
