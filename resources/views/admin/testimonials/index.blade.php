...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm mb-6">
    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between flex-wrap gap-4">
        <div class="flex items-center gap-2">
            <h3 class="font-bold text-gray-800">All Testimonials</h3>
            @if($items->isNotEmpty())
        ...
        <a href="{{ route('admin.testimonials.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-[#2d6fa3] hover:bg-[#1d4e7a] text-white rounded-full text-sm font-semibold transition-colors shadow-sm hover:shadow-md">
...
<div class="bg-white rounded-2xl border border-gray-100">
    <div class="py-16 text-center text-gray-400">
        ...
        <p class="text-sm font-medium text-gray-500">No testimonials yet</p>
        <p class="text-xs mt-1">Click <strong>Create Testimonial</strong> to create your first testimonial.</p>
    </div>
</div>
@else
