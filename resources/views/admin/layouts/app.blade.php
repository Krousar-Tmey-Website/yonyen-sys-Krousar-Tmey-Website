...
<div class="flex h-full">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div x-data="{ show: true }" x-show="show" x-cloak
            ...
            <button @click="show = false" class="p-1 rounded-lg hover:bg-green-100 transition-colors flex-shrink-0" title="Close">
        ...
        <div x-data="{ show: true }" x-show="show" x-cloak
            ...
            <button @click="show = false" class="p-1 rounded-lg hover:bg-red-100 transition-colors flex-shrink-0" title="Close">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
            </button>
        </div>
        @endif
