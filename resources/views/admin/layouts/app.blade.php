    ...
    <div class="flex h-full">
        ...
        <aside x-cloak :class="sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full w-64 lg:translate-x-0 lg:w-[4.5rem]'"
            ...
            <nav id="admin-sidebar-nav" class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                ['route' => 'admin.involved-quick-links.index', 'label' => __('Quick Links Cards')],
                ['route' => 'admin.partner-page.index', 'label' => __('Become a Partner')],
                ['route' => 'admin.volunteer-section.index', 'label' => __('Volunteer Section')],
                ...
                'children' => [
                ['route' => 'admin.contact-page.index', 'label' => __('Contact Page')],
                ['route' => 'admin.offices.index', 'label' => __('Offices')],
