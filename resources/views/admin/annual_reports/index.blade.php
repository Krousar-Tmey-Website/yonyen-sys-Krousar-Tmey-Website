...
<div class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <form action="{{ route('admin.reports.store') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
            @csrf
            <div>
            ...
            <div class="divide-y divide-gray-50">
                ...
                <div x-data="{ editing: false }">
                    ...
                    <div class="px-5 py-4 bg-gray-50 border-t border-gray-100" x-show="editing" x-cloak>
                        <form action="{{ route('admin.reports.update', $report) }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                            @csrf @method('PUT')
