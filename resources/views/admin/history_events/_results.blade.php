...
<div class="bg-white rounded-2xl border border-gray-100 py-16 text-center">
    ...
    <p class="text-gray-400 text-xs mt-1">Add your first history event using the form</p>
    @endif
</div>
@else
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="text-gray-400 text-xs border-b border-gray-50">
                ...
                <th class="text-left font-medium px-6 py-3">Event</th>
            ...
            <tr class="border-t border-gray-50 hover:bg-gray-50/60 transition">
                ...
                <td class="px-6 py-4">
                    <div class="flex items-center justify-end gap-2">
                        <a href="{{ route('admin.history-events.edit', $event) }}" title="Edit"
