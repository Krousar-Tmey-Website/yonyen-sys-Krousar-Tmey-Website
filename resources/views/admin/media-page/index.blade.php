...
@php
    ...
    $bannerTitleFr = $bvFr('media_banner_title');
...
<div x-show="tab === 'banner'" class="space-y-6">
    ...
    <form action="{{ route('admin.media-banner.update') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 p-6 lg:p-8 space-y-5" x-data="bilingualForm()">
        ...
        <div x-show="lang === 'fr'" x-cloak>
            <label for="media_banner_badge_fr" class="block text-sm font-medium text-gray-700 mb-1.5">Badge Text (French) <span class="text-gray-400 font-normal">(optional)</span></label>
            <input type="text" id="media_banner_badge_fr" name="media_banner_badge_fr"
                   value="{{ old('media_banner_badge_fr', $settings['media_banner_badge_fr'] ?? '') }}"
        ...
        <div x-show="lang === 'en'">
            ...
            <x-admin.rich-text id="media_banner_title" name="media_banner_title" :value="$bannerTitle" lang="en" :rows="1" />
        </div>
        <div x-show="lang === 'fr'" x-cloak>
            <label for="media_banner_title_fr" class="block text-sm font-medium text-gray-700 mb-1.5">Hero Title (French) <span class="text-gray-400 font-normal">(optional)</span></label>
            <x-admin.rich-text id="media_banner_title_fr" name="media_banner_title_fr" :value="$bannerTitleFr" lang="fr" :rows="1" placeholder="Krousar Thmey dans les médias" />
        ...
        <div class="border-t border-gray-100 pt-4 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div x-show="lang === 'fr'" x-cloak>
                        <input type="text" id="media_banner_btn1_text_fr" name="media_banner_btn1_text_fr"
                               value="{{ old('media_banner_btn1_text_fr', $settings['media_banner_btn1_text_fr'] ?? '') }}"
                               placeholder="Leave blank to reuse the English text"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div x-show="lang === 'fr'" x-cloak>
                        <input type="text" id="media_banner_btn2_text_fr" name="media_banner_btn2_text_fr"
                               value="{{ old('media_banner_btn2_text_fr', $settings['media_banner_btn2_text_fr'] ?? '') }}"
                               placeholder="Leave blank to reuse the English text"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <div x-show="lang === 'fr'" x-cloak>
                        <input type="text" id="media_banner_btn3_text_fr" name="media_banner_btn3_text_fr"
                               value="{{ old('media_banner_btn3_text_fr', $settings['media_banner_btn3_text_fr'] ?? '') }}"
                               placeholder="Leave blank to reuse the English text"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2d6fa3]/20 focus:border-[#2d6fa3]">
                    </div>
                </div>
