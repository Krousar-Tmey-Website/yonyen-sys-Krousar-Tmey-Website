    ...
    <div class="p-6 space-y-6">
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}" required
                   ...
                   placeholder="e.g. Success Story of Income Generation">
        ...
        <div>
            <h3 class="text-sm font-semibold text-gray-700 mb-4">Images <span class="text-gray-400 font-normal text-xs">(up to 3)</span></h3>
            @foreach([
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                ...
                <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0"
                       class="w-full rounded-xl border-gray-300 focus:border-[#2d6fa3] focus:ring focus:ring-[#2d6fa3]/20 transition-all text-sm">
                <p class="text-xs text-gray-400 mt-1">Lower = appears first on the page</p>
            </div>
