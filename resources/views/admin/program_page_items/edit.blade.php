...
<form action="{{ route('admin.program-pages.update', $item) }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="p-6 space-y-6">
        ...
        <div>
            ...
            <x-admin.rich-text name="short_content" :value="old('short_content', $item->short_content)" lang="en" :rows="3" />
        ...
        <div>
            ...
            <x-admin.rich-text name="detail_content" :value="old('detail_content', $item->detail_content)" lang="en" :rows="14" />
