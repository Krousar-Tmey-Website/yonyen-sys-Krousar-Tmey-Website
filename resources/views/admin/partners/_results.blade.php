                        ...
                        <tr class="border-t border-gray-50 hover:bg-gray-50/60 transition">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.partners.show', $partner) }}" title="View"
                                        class="w-8 h-8 rounded-full bg-emerald-50 text-emerald-600 hover:bg-emerald-100 flex items-center justify-center transition">
