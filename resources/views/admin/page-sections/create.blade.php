...
@section('breadcrumb', 'Homepage Sections → Create')
...
<div>
    ...
    {{-- Form --}}
    <div>
        <form action="{{ route('admin.page-sections.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5" x-data="bilingualForm()">
            @csrf
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 lg:p-8 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="section_name" value="{{ old('section_name') }}" required
                ...
                <div x-show="lang === 'en'">
                    ...
                    <x-admin.rich-text name="description" :value="old('description')" lang="en" :rows="6" placeholder="Write the section content here." />
                    @error('description')
                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div x-show="lang === 'fr'" x-cloak>
                    ...
                    <x-admin.rich-text name="description_fr" :value="old('description_fr')" lang="fr" :rows="6" placeholder="Décrivez cette section en français." />
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 lg:p-8 space-y-4">
                ...
                <div class="grid lg:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Upload Image <span class="text-gray-400 font-normal">(recommended: 800×500px)</span></label>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6 lg:p-8 space-y-4" x-data="linkManager()">
                <div class="flex items-center justify-between">
                    <h3 class="font-semibold text-gray-700 text-sm flex items-center gap-2">
