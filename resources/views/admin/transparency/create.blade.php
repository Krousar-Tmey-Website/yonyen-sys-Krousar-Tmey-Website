            ...
            <div class="grid lg:grid-cols-2 gap-5">
                ...
                <div>
                    <div x-show="lang === 'en'">
                        ...
                        <x-admin.rich-text name="description" :value="old('description')" lang="en" :rows="1" placeholder="PDF · Full Report" />
                    ...
                    <div x-show="lang === 'fr'" x-cloak>
                        ...
                        <x-admin.rich-text name="description_fr" :value="old('description_fr')" lang="fr" :rows="1" placeholder="PDF · Rapport complet" />
