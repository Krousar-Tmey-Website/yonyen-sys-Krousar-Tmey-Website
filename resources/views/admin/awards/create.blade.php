...
@section('breadcrumb', 'Awards → Create')
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select name="link_type"
                        ...
                        <option value="website" {{ old('link_type') == 'website' ? 'selected' : '' }}>Visit Website</option>
                        <option value="article" {{ old('link_type') == 'article' ? 'selected' : '' }}>Read Article</option>
                        <option value="video" {{ old('link_type') == 'video' ? 'selected' : '' }}>Watch Video</option>
                    </select>
