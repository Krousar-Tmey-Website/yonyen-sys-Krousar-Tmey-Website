...
<div class="max-w-3xl mx-auto">
    <form action="{{ route('admin.downloads.update', $item) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
            ...
            <div>
                ...
                <x-admin.rich-text name="description" :value="old('description', $item->description)" lang="en" :rows="3" />
            </div>
