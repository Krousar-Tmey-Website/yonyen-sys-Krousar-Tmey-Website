        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="flex flex-col lg:flex-row gap-16 items-start">
                ...
                <div class="lg:w-7/12 space-y-12">
                    ...
                    {{-- Objective Block --}}
                    @if($project->localized_objective)
                    ...
                    <div class="pt-4" data-reveal="up">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            ...
                            <div class="bg-white rounded-3xl border border-gray-100 p-6 flex flex-col gap-2 shadow-sm hover:border-[#8da83a]/30 hover:shadow-md transition-all group">
                                ...
                                <div class="mt-2">
                                    <p class="text-[11px] font-black text-[#8da83a] uppercase tracking-widest mb-1">{{ $grant->localized_title ?: 'Grant' }}</p>
                                    ...
                                    <p class="text-[13px] text-gray-500 mt-2 font-medium leading-snug">
                                        @if($grant->localized_label){{ $grant->localized_label }}@endif
                                        @if($grant->localized_label && $grant->recipient) &middot; @endif
                    ...
                    <div class="pt-10 mt-10 border-t border-gray-100" data-reveal="up">
                        ...
                        <div class="flex gap-3">
                            @php
                                ...
                                $shareTitle = urlencode($project->localized_title);
                            @endphp
                            {{-- Facebook --}}
                            ...
                            {{-- Generic Share --}}
                            <button onclick="if(navigator.share) { navigator.share({title: '{{ $project->localized_title }}', url: '{{ $shareUrl }}'}); }"
                ...
                <div class="lg:w-5/12 space-y-8 lg:sticky lg:top-28" x-data="{ lightboxImage: null }">
                    ...
                    <div class="relative w-full h-[300px] lg:h-[350px] cursor-pointer group rounded-3xl overflow-hidden shadow-sm" @click="lightboxImage = '{{ $project->image_url }}'" data-reveal="left">
                        <img src="{{ $project->image_url }}" alt="{{ $project->localized_title }}" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105">
