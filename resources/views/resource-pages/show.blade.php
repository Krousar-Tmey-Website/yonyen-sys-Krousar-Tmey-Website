...
<article class="py-12 bg-white">
    <div class="max-w-4xl mx-auto px-6">
        ...
        {{-- Header --}}
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-extrabold text-[#1a3c6e] leading-tight mb-8">
        ...
        <div class="mb-8 -mx-6 md:mx-0">
            <img src="{{ $page->detail_image_url }}" alt="{{ $page->title }}" class="w-full object-cover">
        </div>
        @endif

        {{-- Description --}}
        @if($page->detail_description)
        <div class="prose prose-lg max-w-none text-justify prose-p:text-gray-700 mb-8">
            ...
            <div class="divide-y divide-gray-100">
                ...
                <div class="py-6 first:pt-0">
                    ...
                    <a href="{{ route('news.show', $article->slug) }}"
                       class="inline-flex items-center gap-1.5 bg-[#2d6fa3] text-white text-xs font-bold px-4 py-2 rounded-full hover:bg-[#1a4a7a] transition-colors">
                        Read More
        ...
        {{-- Back --}}
        <div class="mt-12 pt-8 border-t border-gray-100">
            <a href="{{ route('resource-pages.index') }}" class="inline-flex items-center gap-2 text-[#2d6fa3] font-medium hover:text-[#1a4a7a] transition-colors">
