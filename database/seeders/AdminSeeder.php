...
class AdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $homeSettings = [
            ...
            // Presentation Banner group
            ['key' => 'presentation_banner_image',         'label' => 'Banner Background Image (URL or upload path)', 'group' => 'presentation_banner', 'value' => ''],
            ['key' => 'presentation_banner_overlay_color', 'label' => 'Banner Overlay Color', 'group' => 'presentation_banner', 'value' => '#1a3c6e'],
            ['key' => 'presentation_banner_badge',         'label' => 'Banner Badge Text',    'group' => 'presentation_banner', 'value' => 'Since 1991'],
            ['key' => 'presentation_banner_title',         'label' => 'Banner Title',         'group' => 'presentation_banner', 'value' => 'Krousar Thmey, the first Cambodian organization helping disadvantaged children'],
            ['key' => 'presentation_banner_subtitle',      'label' => 'Banner Subtitle',      'group' => 'presentation_banner', 'value' => 'Born in 1991 in the Site II refugee camp in Thailand, Krousar Thmey has been supporting children for over 25 years.'],
            ['key' => 'presentation_banner_subtitle_fr',   'label' => 'Banner Subtitle (French)',      'group' => 'presentation_banner', 'value' => ''],
            ['key' => 'presentation_banner_btn1_text',     'label' => 'Button 1 — Text', 'group' => 'presentation_banner', 'value' => 'Learn More'],
            ['key' => 'presentation_banner_btn1_url',      'label' => 'Button 1 — URL',  'group' => 'presentation_banner', 'value' => '/our-programs'],
            ['key' => 'presentation_banner_btn2_text',     'label' => 'Button 2 — Text', 'group' => 'presentation_banner', 'value' => 'Donate Now'],
            ['key' => 'presentation_banner_btn2_url',      'label' => 'Button 2 — URL',  'group' => 'presentation_banner', 'value' => '/donate'],
            ['key' => 'presentation_banner_btn3_text',     'label' => 'Button 3 — Text (optional)', 'group' => 'presentation_banner', 'value' => ''],
            ['key' => 'presentation_banner_btn3_url',      'label' => 'Button 3 — URL (optional)',  'group' => 'presentation_banner', 'value' => ''],
