...
class AdminSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $homeSettings = [
            ...
            // Words and Pictures application page
            ['key' => 'words_pictures_title', 'label' => 'Words and Pictures — Page Title', 'group' => 'words_pictures', 'value' => 'Words and Pictures Application'],
            ['key' => 'words_pictures_objective_heading', 'label' => 'Words and Pictures — Objective Heading', 'group' => 'words_pictures', 'value' => 'Objective'],
            ['key' => 'words_pictures_objective_text', 'label' => 'Words and Pictures — Objective Text', 'group' => 'words_pictures', 'value' => 'To enable children with hearing and speech impairments and their relatives and friends access a tool to practice Cambodian Sign Language.'],
            ['key' => 'words_pictures_project_heading', 'label' => 'Words and Pictures — Project Heading', 'group' => 'words_pictures', 'value' => 'Project'],
            ['key' => 'words_pictures_project_p1', 'label' => 'Words and Pictures — Project Paragraph 1', 'group' => 'words_pictures', 'value' => "For over 25 years, Krousar Thmey has implemented a unique mix of special and inclusive education for children with sensory disabilities in Cambodia, developing a unique expertise in visual and hearing impairments with an established track record of results, transforming lives through education, and lastingly influencing national policies. Children with hearing disabilities face many challenges in terms of communication, and have specific educational needs requiring adapted resources. As technology is an ever growing means of providing access to education and communication, Krousar Thmey is launching an educative and innovative mobile phone application:"],
            ['key' => 'words_pictures_app_name', 'label' => 'Words and Pictures — App Name', 'group' => 'words_pictures', 'value' => 'Words and Pictures'],
            ['key' => 'words_pictures_project_p2', 'label' => 'Words and Pictures — Project Paragraph 2', 'group' => 'words_pictures', 'value' => 'Based on a very intuitive interface and simple design, the inclusive application is readily accessible to a very wide audience, and equally useful for families with young children with or without disabilities. Featuring over 500 words relevant to every-day life situations, selected for their suitability to the Cambodian background, the purpose of the application is to offer a fun picture dictionary with integrated sounds and sign language pictograms.'],
            ['key' => 'words_pictures_download_prefix', 'label' => 'Words and Pictures — Download Line Prefix', 'group' => 'words_pictures', 'value' => 'To download the application on your smartphone, please visit:'],
            ['key' => 'words_pictures_download_url', 'label' => 'Words and Pictures — Download URL', 'group' => 'words_pictures', 'value' => 'http://onelink.to/krousarthmey'],
            ['key' => 'words_pictures_download_suffix', 'label' => 'Words and Pictures — Download Line Suffix', 'group' => 'words_pictures', 'value' => 'or scan the QR code below.'],
            ['key' => 'words_pictures_thanks_text', 'label' => 'Words and Pictures — Thanks / Credits', 'group' => 'words_pictures', 'value' => 'Many thanks to Judit van Geystelen for the original idea and design, Open Institute for the development, as well as the Ministry of Education, Youth and Sport of Cambodia, Symphasis Foundation, and Clariant Foundation for their support.'],
            ['key' => 'words_pictures_dedication_text', 'label' => 'Words and Pictures — Dedication', 'group' => 'words_pictures', 'value' => 'This application is dedicated to Tina.'],
            ['key' => 'words_pictures_contact_prefix', 'label' => 'Words and Pictures — Contact Line Prefix', 'group' => 'words_pictures', 'value' => 'If you are interested in developing this application in the language of your choice, please contact:'],
            ['key' => 'words_pictures_contact_email', 'label' => 'Words and Pictures — Contact Email', 'group' => 'words_pictures', 'value' => 'sign.picture.dictionary@gmail.com'],
            ['key' => 'words_pictures_learn_more_text', 'label' => 'Words and Pictures — "Learn More" Button Text', 'group' => 'words_pictures', 'value' => 'Learn more about the projects of this program'],
            ['key' => 'words_pictures_learn_more_url', 'label' => 'Words and Pictures — "Learn More" Button URL', 'group' => 'words_pictures', 'value' => route('programs.show', 'special-education')],
            ['key' => 'words_pictures_donate_url', 'label' => 'Words and Pictures — "Donate Now" Button URL', 'group' => 'words_pictures', 'value' => route('donate')],
            ['key' => 'words_pictures_press_heading', 'label' => 'Words and Pictures — Press Section Heading', 'group' => 'words_pictures', 'value' => 'Words and Pictures in the News'],
            ['key' => 'words_pictures_press_image_caption', 'label' => 'Words and Pictures — Press Photo Caption', 'group' => 'words_pictures', 'value' => "The newly launched 'Words and Pictures' app is dedicated to helping children with hearing and speech impairments. Supplied"],
            ['key' => 'words_pictures_press_source_label', 'label' => 'Words and Pictures — Press Source Label', 'group' => 'words_pictures', 'value' => 'Press Article'],
            ['key' => 'words_pictures_press_source_name', 'label' => 'Words and Pictures — Press Publication Name', 'group' => 'words_pictures', 'value' => 'The Phnom Penh Post'],
            ['key' => 'words_pictures_press_headline', 'label' => 'Words and Pictures — Press Headline', 'group' => 'words_pictures', 'value' => 'Krousar Thmey empowering children with hearing issues'],
            ['key' => 'words_pictures_press_date', 'label' => 'Words and Pictures — Press Published Date', 'group' => 'words_pictures', 'value' => '04.27.2020'],
            ['key' => 'words_pictures_press_excerpt', 'label' => 'Words and Pictures — Press Excerpt', 'group' => 'words_pictures', 'value' => 'As children with hearing disabilities face many challenges in terms of communication and have specific educational needs, Krousar Thmey has utilised technology to create a mobile learning app as a resource for disadvantaged children…'],
        ];
