...
class ProgramsBannerController extends Controller
{
    public function index()
    {
        $settings = HomeSetting::where('group', 'programs_banner')
            ->orWhereIn('key', ['programs_banner_title_fr', 'programs_banner_subtitle_fr', 'programs_cta_title_fr', 'programs_cta_subtitle_fr'])
            ->orderBy('id')
            ->get()
            ->keyBy('key');
    ...
    {
        $request->validate([
            'programs_banner_title'     => ['required', 'string'],
            'programs_banner_title_fr'  => ['nullable', 'string'],
            ...
            'programs_cta_title'        => ['nullable', 'string'],
            'programs_cta_title_fr'     => ['nullable', 'string'],
        ...
        HomeSetting::setValue('programs_banner_title_fr', $request->input('programs_banner_title_fr', ''));
        ...
        HomeSetting::setValue('programs_cta_title_fr', $request->input('programs_cta_title_fr', ''));
