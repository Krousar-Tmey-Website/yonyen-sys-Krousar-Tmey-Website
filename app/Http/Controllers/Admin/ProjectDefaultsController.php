...
class ProjectDefaultsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $data = $request->validate([
            ...
            'project_default_make_difference_title' => ['nullable', 'string', 'max:2000'],
            'project_default_make_difference_text' => ['nullable', 'string', 'max:2000'],
            'project_default_make_difference_title_fr' => ['nullable', 'string', 'max:2000'],
    ...
    public function updateProject(Request $request, Project $project)
    {
        $validator = Validator::make($request->all(), [
            ...
            'make_difference_title' => ['nullable', 'string', 'max:2000'],
            'make_difference_text' => ['nullable', 'string', 'max:2000'],
            'make_difference_title_fr' => ['nullable', 'string', 'max:2000'],
